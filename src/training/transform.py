...
def eval_metric_calculations(y_test ,y_pred , y_prob) -> dict:
    ...
    metric_dictionary = {'acuracy' : accuracy ,  'roc__auc_score' : roc_auc ,'classification_report' : report  }
...
def gs_train_rf_classifier(self) -> dict:
    ...
    for i in run_names:
        ...
        clf = RandomForestClassifier(n_estimators= training_paramaters_dict['n_estimators'],
        ...
        model_details = {'training_run_parameters': training_paramaters_dict , 
                        'trained_model' : clf, 'eval_scores' : metric_dictionary ,
                                                             'y_pred' : y_pred,
                                                             'y_prob': y_prob ,
                                                             'y_test' : self.y_test}
